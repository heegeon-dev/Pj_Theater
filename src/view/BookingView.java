...
public class BookingView extends JPanel implements ActionListener {
	...
	public void addLayout() {
		...
		printButton = new JButton("예매 내역 출력");
